...
class AP3_images extends AP3_GUI{
    ...
    protected void run() throws InterruptedException, Exception {
        ...
        */ 
        ...
        if (FAIL) { return;}
        //check initial api
        Call_API_Auth("Check API before toggle", BaseAPI + "/location/sector/" + SectorID + "?nocache=true&expanded=true", true, ParentTest, "no_jira");
        ...
        if (FAIL) { return;}
        Element_By_Path_Click("Click > 'Cancel'", "xpath", "(//*[contains(text(),'Cancel')])[3]", ParentTest, "no_jira"); 
        if (FAIL) { return;} 
        Thread.sleep(500);
        EX += " - " + "\t" + " === " + "\t" + " ===== " + "\t" + " ==  >>" + "\t" + " - " + "\t" + " - " + "\t" + " -" + "\t" + " - " + "\r\n";
        // </editor-fold>
