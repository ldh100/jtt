...
public class DL_metric_data {
	...
	//Select Total Spend // Compared to Last Year
        ...
        Thread.sleep(5000);
        _t++; Thread.sleep((long) sleep); T.Element_By_Path_Click("Click on the Dropdown List ", "xpath", "//body/div[@id='root']/div[1]/div[3]/div[2]/div[1]/div[1]/div[4]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]", "no_jira"); 
            if (FAIL) { return;}
  
         _t++; Thread.sleep((long) sleep); T.Element_By_Path_Click("Click on the Compared to last month", "xpath", "(//li[starts-with(@class,'MuiButtonBase-root')])[2]", "no_jira"); 
            if (FAIL) { return;}
           Thread.sleep(4000);
        _t++; Thread.sleep((long) sleep); T.Element_By_Path_Text("Get the 'Total Spend' amount ", "xpath", "//div[starts-with(@class,'MuiCardContent-root jss')]/div[2]/div[2]/p", "no_jira");
            if (FAIL) { return;} 
        ...
        _t++; Thread.sleep((long) sleep); T.Element_By_Path_Click("Click on the Dropdown List ", "xpath", "//body/div[@id='root']/div[1]/div[3]/div[2]/div[1]/div[1]/div[4]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]", "no_jira"); 
         ...
         _t++; Thread.sleep((long) sleep); T.Element_By_Path_Click("Click on the Compared to last week", "xpath", "(//li[starts-with(@class,'MuiButtonBase-root')])[3]", "no_jira"); 
            if (FAIL) { return;}
           Thread.sleep(4000);
        _t++; Thread.sleep((long) sleep); T.Element_By_Path_Text("Get the 'Total Spend' amount ", "xpath", "//div[starts-with(@class,'MuiCardContent-root jss')]/div[2]/div[2]/p", "no_jira");
            if (FAIL) { return;} 
