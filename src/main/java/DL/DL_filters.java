...
class DL_filters extends DL_GUI {
    protected DL_filters(DL_GUI a) {
...
//    	Thread.sleep(6000);
//
//        Wait_For_Element_By_Path_Presence("Wait for side bar", "xpath", "(//span[@class='MuiButton-label'])[1]/span", ParentTest, "no_jira"); 
...
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_DisplayCheck("Delete the existing item", "xpath", "(//div[contains(@class,'MuiChip-deletable')]/*[name()='svg'])[1]", ParentTest, "no_jira"); 
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_DisplayCheck("Delete the existing item", "xpath", "(//div[contains(@class,'MuiChip-deletable')]/*[name()='svg'])[2]", ParentTest, "no_jira"); 
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_DisplayCheck("Delete the existing item", "xpath", "(//div[contains(@class,'MuiChip-deletable')]/*[name()='svg'])[1]", ParentTest, "no_jira"); 
//        if (FAIL) { return;}
...
//        if (FAIL) { return;}
//        //Division 
//        Element_By_Path_Click("Cick on first dropdown menu", "xpath", "(//div[contains(@class,'indicatorContainer')])[position()=3]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Element_By_Path_Click("choose 'Division Name' from the dropdown box", "xpath", "(//*[contains(text(), 'Division')])[4]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_Path_Click("Select 1st item from the list box", "xpath", "//div[@role='dialog']//div[starts-with(@class,'jss')]/div/div[1]/div[1]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
////        Sector
//        Thread.sleep(6000);
//        Element_By_Path_Click("Cick on first dropdown menu", "xpath", "(//div[contains(@class,'indicatorContainer')])[position()=3]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Element_By_Path_Click("choose 'Sector Name' from the dropdown box", "xpath", "//*[contains(text(), 'Sector')]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_Path_Click("Select 1st item from the list box", "xpath", "//div[@role='dialog']//div[starts-with(@class,'jss')]/div/div[1]/div[1]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
...
//        Element_By_Path_Click("Cick on first dropdown menu", "xpath", "(//div[contains(@class,'indicatorContainer')])[position()=3]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Element_By_Path_Click("choose 'District Name' from the dropdown box", "xpath", "//*[contains(text(), 'District')]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_Path_Click("Select 2nd item from the list box", "xpath", "//div[@role='dialog']//div[starts-with(@class,'jss')]/div/div[2]/div[1]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//    //    Region
//        Thread.sleep(6000);
//        Element_By_Path_Click("Cick on first dropdown menu", "xpath", "(//div[contains(@class,'indicatorContainer')])[position()=3]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Element_By_Path_Click("choose 'Region Name' from the dropdown box", "xpath", "(//*[contains(text(), 'Region')])[4]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_Path_Click("Select 1st item from the list box", "xpath", "//div[@role='dialog']//div[starts-with(@class,'jss')]/div/div[1]/div[1]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
...
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_Path_Click("Click on dropdown menu", "xpath", "(//div[contains(@class,'indicatorContainer')]/*[name()='svg'])[position()=2]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Thread.sleep(6000);
//        Element_By_Path_Click("Click on dropdown menu", "xpath", "//*[contains(text(), 'Beverages')]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        Thread.sleep(2000);
//        Scroll_to_WebElement("Scroll to apply dropdown",  "xpath", "//span[contains(.,'Apply')]", ParentTest, "no_jira"); 
//   	if (FAIL) { return;}
//   	Element_By_Path_Click("Cick on Apply button", "xpath", "//span[contains(.,'Apply')]", ParentTest, "no_jira");  
//        if (FAIL) { return;}
//        
//        Thread.sleep(8000);
//    }
