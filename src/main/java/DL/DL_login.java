...
public class DL_login {
    public static void run(boolean Invalid_Login) throws InterruptedException {     
...
//            if (FAIL) { return;}             
        ...
        if(Invalid_Login){            
            ...
            _t++; TWeb.Element_By_Path_Text_Enter("Enter Valid Username", "id", "username", "distilr.test1@place.com", false, "no_jira"); 
                 if (FAIL) { return;}            
