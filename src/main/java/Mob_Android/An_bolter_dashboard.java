...
class An_bolter_dashboard extends An_GUI{
    ...
    protected void Run() throws InterruptedException, Exception{         
        //<editor-fold defaultstate="collapsed" desc="Delivery Dashboard">
        EX += "\r\n" + " - " + "\t" + " === Delivery Dashboard ====" + "\t" + "==== " + "\t" + " == Begin > ==" + "\t" + " - " + "\t" + " - " + "\t" + " - " + "\t" + " - " + "\r\n";                
        ...
        Wait_For_Element_By_Path_InVisibility("Wait for load", "id", "progress_bar", ParentTest, "no_jira");
            if (FAIL) { return;} 
//Element_By_Path_Text("Get Dashboard 'Title'", "id", "delivery_dashboard_title", ParentTest, "no_jira");   <<< this id gone after Sep 23 
