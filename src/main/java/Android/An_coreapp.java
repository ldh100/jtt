...
//                if (FAIL) { return;}             
        ...
        _t++; Element_By_Path_Click("Click 'Account'", "id", "account", "no_jira");             
            if (FAIL) { return;}  
        _t++; Wait_For_Element_By_Path_Presence("Wait for 'Account' screen", "id", "profile_menu", "no_jira");             
            if (FAIL) { return;}
        _t++; Swipe_From_Screen_Center("Swipe Up to show 'Logout'", "UP", 500, "no_jira");             
            if (FAIL) { return;}              
            
        _t++; Wait_For_Element_By_Path_Presence("Wait for 'Version' visible", "id", "appVersion", "no_jira");             
            if (FAIL) { return;}             
