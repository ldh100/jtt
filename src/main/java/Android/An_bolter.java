...
class An_bolter extends An_GUI{
    ...
    protected void Run() throws InterruptedException {         
        ...
        Element_By_Path_Action_Click("Click 'Forgot PW?' button", "id", "btn_forgotPassword", "no_jira");
            if (FAIL) { return;}        
        Thread.sleep(500);
        ...
        Element_By_Path_Action_Click("Click 'SEND...' button", "id", "btnRequestResetLink", "no_jira");
            if (FAIL) { return;} 
        Thread.sleep(500);
        ...
        //<editor-fold defaultstate="collapsed" desc="Login, User Name, Version">
        ...
        Element_By_Path_Action_Click("Click 'Email' input", "id", "textInputEditText_login_email_address", "no_jira");
            if (FAIL) { return;}
        Element_By_Path_Text_Enter("Enter InValid 'Email'", "id", "textInputEditText_login_email_address", "X" + Bolter_ID, false,"no_jira");
            if (FAIL) { return;}
        ...
        Element_By_Path_Text("Get 'Alert Message'", "id", "alertTitle", "no_jira");
        Element_By_Path_Click("Click Alert 'OK' button", "id", "android:id/button1", "no_jira");            
            if (FAIL) { return;}
        ...
        Wait_For_Element_By_Path_Presence("Wait for 'Dashboard' screen", "id", "delivery_dashboard_title", "no_jira");
            if (FAIL) { return;}
        Element_By_Path_Action_Click("Click 'Open Navigation drawer' image", "xpath", "//android.widget.ImageButton[@content-desc='Open navigation drawer']", "no_jira");
            if (FAIL) { return;}
        ...
        List_L1("Delivery Hours Count", "id", "txtDeliveryHours", "no_jira" );
            for (int i = 0; i < aL1.size(); i++) {
                _t++; Element_Text("Brand Name (index " + i + ")", aL0.get(i),  "no_jira");         
                _t++; Element_Text("Brand Delivery Hours (index " + i + ")", aL1.get(i),  "no_jira");         
            }   
        ...
        Wait_For_Element_By_Path_Presence("Wait for 'Dashboard' screen", "xpath", "//android.widget.ImageButton[@content-desc='Open navigation drawer']", "no_jira");
            if (FAIL) { return;}        
        Element_By_Path_Action_Click("Click 'Open Navigation drawer' image", "xpath", "//android.widget.ImageButton[@content-desc='Open navigation drawer']", "no_jira");
        ...
        Wait_For_Element_By_Path_Presence("Wait for 'Dashboard' screen", "xpath", "//android.widget.ImageButton[@content-desc='Open navigation drawer']", "no_jira");
            if (FAIL) { return;}        
        Element_By_Path_Action_Click("Click 'Open Navigation drawer' image", "xpath", "//android.widget.ImageButton[@content-desc='Open navigation drawer']", "no_jira");    
        Element_By_Path_Action_Click("Click 'Log out'", "id", "nav_logout", "no_jira");
        //</editor-fold>
    }
}
