...
class WO_login extends WO_GUI {
    ...
    try {    
        ...
        Element_By_Path_Click("Click 'Log In'", "xpath", "//*[text()='Log In']", ParentTest, "no_jira"); 
            if (FAIL) { return;}             
        Thread.sleep(500);   
        ...
        if(_New_user) {
            ...
            // Element_E1_Find("Find 'Login' dialog", "xpath", "//html/body/div/div/div[3]/div/div/div", ParentTest, "no_jira");
             //   if (FAIL) { return;} 
              //  Thread.sleep(500);      
            Element_By_Path_Text("Find 'switch-form-text > Sign-in' text", "xpath", "//p[@class='switch-form-text']", ParentTest, "no_jira");
            Element_By_Path_Click("Click 'Sign up'", "xpath", "//p[text()='Sign Up']", ParentTest, "no_jira");
                if (FAIL) { return;}
        ...
        //  Verify all input field
            ...
            Element_By_Path_Click("Click 'Create Account'", "xpath", "(//button[@type='button'])[11]",  ParentTest, "no_jira");
                 if (FAIL) { return;} 
