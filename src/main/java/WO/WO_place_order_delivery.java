...
class WO_place_order_delivery extends WO_GUI {
    ...
    try{    
        ...
        if (!DELIVERY){
            _t++; _w++;
            EX += _t + "\t" + "Site " + SITE + " - Delivery service is not available" + "\t" + " ===== " + "\t" + "No Brands offering Delivery" + "\t" + "WARN" + "\t" + " - " + "\t" + " - " + "\t" + " - " + "\r\n";
            Log_Html_Result("WARN", "No Brands offering Delivery", true, ParentTest.createNode(_t + ". " + "Site " + SITE + " - Delivery service is not available"), new Date());
            return;
        }
...
//            } 
        if(L1.isEmpty()) {
            _t++; _w++;
            EX += _t + "\t" + "Site " + SITE + " - Delivery service is not available" + "\t" + " ===== " + "\t" + "No Brands offering Delivery" + "\t" + "WARN" + "\t" + " - " + "\t" + " - " + "\t" + " - " + "\r\n";
            Log_Html_Result("WARN", "Site " + SITE + " - No Brands offering Delivery", true, ParentTest.createNode(_t + ". " + "No Brands offering Delivery"), new Date());
            return;
        }
//                    for (int j = 0; j < L1.size(); j++) {
...
//                    }   
        ...
        // Timeslots
        Element_By_Selector_Click("Open 'Delivery time/Timeslots' drop-down", "xpath", "//input[@placeholder='Select a Delivery time']", ParentTest, "no_jira");
            if (FAIL) { return;}
