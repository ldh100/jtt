...
class promo extends API_GUI {
    ...
    protected void promoAPIs() {
        ...
        BODY = "{"
                ...
                + "\"main\":["
                + "{"
                + "\"id\":\"QkRwejd273crMkgj6aNPUweXamJ9OdH9Dq4QayP3Uj2L2gKAAwsmdalm3aQlS6yQ6Ge\","
                + "\"quantity\":1,"
                + "\"price\":{"
                + "\"amount\":1"
                + "},"
        ...
        BODY = "{"
                ...
                + "\"additional\":["
                + "{"
                + "\"id\":\"6evoORLMl7tQYLJW7lm7so9j27meLRfQzNwNoGrPH8OZlmkZmAC3l6ga7RlDtR2r5pO\","
                + "\"quantity\":1,"
                + "\"price\":{"
                + "\"amount\":7"
                + "},"
                ...
                + "},"
                + "{"
                + "\"id\":\"qgAlkGv4y9s85BdmJw99tl1ePzyePYiRP9mgkEgMt16WJ8oOEGtGMjXpaj6PH0kk2eN\","
                + "\"quantity\":1,"
                + "\"price\":{"
                + "\"amount\":5"
                + "},"
