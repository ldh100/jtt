...
//        Kepp filtered - only new Location for delete them below
        ...
        for (int i = (L1.size() - 1); i >= 0; i--) {
            ...
            if (!t.contains("No locations found") && t.contains(New_ID)) {
                ...
                //Scroll_to_Element("Scroll to Location " + i, e, ParentTest, "no_jira");
                //Move_to_Element_By_Path("Move to Location " + i, "xpath", "//aside[contains(@class, 'navigation-drawer')]", ParentTest, "no_jira");             
