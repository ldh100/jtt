...
public class AP3_site {
    public static void run() throws InterruptedException { 
        ...
        _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Attribute("Page Title", "xpath", "//div[contains(@class, 'H3-Primary')]", "textContent", "no_jira");
            if (FAIL) { return;}          
        _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Text("Button 'Add new...' Text ", "xpath", "//button[contains(@class, 'v-btn theme--light primary')]", "no_jira"); 
            if (FAIL) { return;}            
        ...
        _t++; Thread.sleep((long) sleep); TWeb.To_Top("no_jira");
            if (FAIL) { return;} 
        _t++; Thread.sleep((long) sleep); TWeb.Element_Click("Site Name Sort Click", L1.get(0), "no_jira"); 
            if (FAIL) { return;} 
            for (int i = 0; i < L1.size(); i++) {
                _t++; TWeb.Element_Attribute("Sortable Column Label", L1.get(i), "aria-label", "no_jira");
                if (FAIL) { return;}
        ...
        _t++; Thread.sleep((long) sleep); TWeb.Element_Click("Unit # Click", L1.get(5), "no_jira"); 
            if (FAIL) { return;} 
            for (int i = 0; i < L1.size(); i++) {
                _t++; TWeb.Element_Attribute("Sortable Column Label", L1.get(i), "aria-label", "no_jira");           
                if (FAIL) { return;}
        ...
        _t++; Thread.sleep((long) sleep);  TWeb.Element_By_Path_Text("Site Station List text", "xpath", "//div[contains(@class, 'H6-Selected')]", "no_jira");
            if (FAIL) { return;}     
        _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Text("Site Configuration text", "xpath", "//*[contains(text(), 'Configuration')]", "no_jira"); 
            if (FAIL) { return;}                                                                                         
        ...
        _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Click("Training Video Icon Click", "xpath", "//i[contains(@class, 'v-icon mdi mdi-help-circle')]", "no_jira"); 
            if (FAIL) { return;}     
        Thread.sleep(500);               
        _t++; Thread.sleep((long) sleep); TWeb.Wait_For_All_Elements_InVisibility("Wait for 'progress'...", "xpath", "//*[contains(@class, 'progress')]", "no_jira"); 
            if (FAIL) { return;}  
        _t++; Thread.sleep((long) sleep); TWeb.Swith_to_Frame("Switch to Video Player", "tagName", "iframe", "no_jira");// iframe src="https://player.vimeo.com/video/412472158"
            if (FAIL) { return;} 
        ...
        _t++; Thread.sleep((long) sleep); TWeb.Wait_For_All_Elements_InVisibility("Wait for 'progress'...", "xpath", "//*[contains(@class, 'progress')]", "no_jira"); 
            if (FAIL) { return;}  
        _t++; Thread.sleep((long) sleep); TWeb.List_L0("Site Configuration sections Count", "xpath", "//div[contains(@class, 'SelectedLeft')]", "no_jira");             
            if (FAIL) { return;} 
        for (int i = 0; i < L0.size(); i++) {
            switch (i) {
                case 0:
                    _t++; TWeb.Element_Text("Definition section", L0.get(i), "no_jira");             
                        if (FAIL) { return;} 
                    ...
                    _t++; Thread.sleep((long) sleep); TWeb.Find_Text("Find 'Location Details' text", "Location Details", true,"no_jira"); 
                       if (FAIL) { return;}
                    _t++; TWeb.Element_By_Path_Text("Find 'Timezone' text", "className", "timezone", "no_jira"); 
                        if (FAIL) { return;}                        
                    ...
                    _t++; TWeb.Find_Text("Find 'State' text", "State", true,"no_jira"); 
                            if (FAIL) { return;}                         
                        if(COUNTRY.toLowerCase().contains("ca")){
//                        _t++; TWeb.Find_Text("Find 'Province' text", "Province", true,"no_jira"); 
//                            if (FAIL) { return;} 
                        _t++; TWeb.Find_Text("Find 'Postal Code' text", "Postal Code", true,"no_jira"); 
                            if (FAIL) { return;} 
                    } else {
                        _t++; TWeb.Find_Text("Find 'Zip Code' text", "Zip Code", true,"no_jira"); 
                            if (FAIL) { return;} 
                        }  
                ...
                case 2:
                    ...
                    _t++; Thread.sleep((long) sleep); TWeb.Element_Click("Mealplan Info Click", L0.get(i), "no_jira");
                        if (FAIL) { return;} 
                    _t++; Thread.sleep((long) sleep); TWeb.Find_Text("Find 'Meal Plan' text", "Meal Plan", true,"no_jira"); 
                        if (FAIL) { return;}
                      break;
                case 3:
                    ...
                    _t++; TWeb.Find_Text("Find 'Yes' text", "Yes", true,"no_jira"); 
                        if (FAIL) { return;}
//                  _t++; Thread.sleep((long) sleep); TWeb.Find_Text("Find 'No' text", "No", "no_jira"); 
//                      if (FAIL) { return;}
                   break;
                case 4:
                    ...
                    _t++; Thread.sleep((long) sleep); TWeb.Find_Text("Find 'Promotions' text", "Promotions", true,"no_jira"); 
                        if (FAIL) { return;}
                    _t++; TWeb.List_L1("Promotions Count", "tagName", "tr", "no_jira");             
                        if (FAIL) { return;} 
        ...
        _t++; Thread.sleep((long) sleep); TWeb.Navigate_Back("Navigate Back", SITE + "Site Configuration","Station List", "no_jira");
            //if (FAIL) { return;}
        Thread.sleep(500); 
        _t++; Thread.sleep((long) sleep); TWeb.Wait_For_All_Elements_InVisibility("Wait for 'progress'...", "xpath", "//*[contains(@class, 'progress')]", "no_jira"); 
            if (FAIL) { return;}               
        _t++; Thread.sleep((long) sleep); TWeb.Navigate_Back("Navigate Back", SITE + "Station List","App Sites page", "no_jira");
            //if (FAIL) { return;}
        Thread.sleep(500); 
        _t++; Thread.sleep((long) sleep); TWeb.Wait_For_All_Elements_InVisibility("Wait for 'progress'...", "xpath", "//*[contains(@class, 'progress')]", "no_jira"); 
            if (FAIL) { return;}               
...
//                        _t++; Thread.sleep((long) sleep); TWeb.List_L1("Selected Apps Count", "xpath", ".//div[contains(@class,'v-messages__message')]", "no_jira");             
//                            if (FAIL) { return;}     
                    break;
                case 1:
                   _t++; TWeb.Element_Text("Payment section", L0.get(i), "no_jira");             
...
//                    _t++; Thread.sleep((long) sleep); TWeb.List_L1("Promo Types Count", "xpath", "/html/body/div/div[4]/div/div/div", "no_jira");             
//                        if (FAIL) { return;} 
                            for (int j = 0; j < L1.size(); j++) {
...
//                        if (FAIL) { return;} 
                    ...
                    _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Click("Create promo 'Save Changes' Click", "xpath", "//*[contains(text(), 'save changes')]", "no_jira"); 
                        if (FAIL) { return;}  
//                        _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Click("Create promo 'Cancel' Click", "xpath", "//*[contains(text(), 'cancel')]", "no_jira"); 
//                            if (FAIL) { return;}
                    _t++; TWeb.List_L1("Promotions Count", "tagName", "tr", "no_jira");             
                        if (FAIL) { return;} 
                        for (int j = 0; j < L1.size(); j++) {
...
//                        _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Click("Create promo 'Cancel' Click", "xpath", "//*[contains(text(), 'cancel')]", "no_jira"); 
//                            if (FAIL) { return;}
                    _t++; TWeb.List_L1("Promo Count - Only 1 Active", "tagName", "tr", "no_jira");             
                        if (FAIL) { return;} 
                        for (int j = 0; j < L1.size(); j++) {
                            _t++; TWeb.Element_Text("Promotion Data Row", L1.get(j), "no_jira");             
                            if (FAIL) { return;}
        ...
        _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Click("New Site 'Cancel' Click", "xpath", "//*[contains(text(), 'Cancel')]","no_jira");             
            if (FAIL) { return;}         
        _t++; Thread.sleep((long) sleep); TWeb.Navigate_Back("Navigate Back","Add New Site page","App Site page", "no_jira"); 
        Thread.sleep(500); 
        _t++; Thread.sleep((long) sleep); TWeb.Wait_For_All_Elements_InVisibility("Wait for 'progress'...", "xpath", "//*[contains(@class, 'progress')]", "no_jira"); 
            if (FAIL) { return;}           
        // </editor-fold> 
