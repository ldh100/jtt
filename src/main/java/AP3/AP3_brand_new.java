...
//                                _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Click("Click 'Message On...'", "xpath", "//*[contains(text(), 'Message On Receipt')]", "no_jira"); 
                ...
                case "Payment Method Exclusion":  
                    ...
                    _t++; Thread.sleep((long) sleep); TWeb.Find_Text("Find 'Google Wallet'", "Google Wallet", true,"no_jira"); 
                        if (FAIL) { return; }                    
                    _t++; Thread.sleep((long) sleep); TWeb.Find_Text("Find 'Meal Plans'", "Meal Plans", false,"no_jira"); 
                        if (FAIL) { return; } 
                    _t++; Thread.sleep((long) sleep); TWeb.Find_Text("Find 'Excluded tenders'", "Excluded tenders", false,"no_jira"); 
                        if (FAIL) { return; } 
                    if(L1.size() > 0){
        ...
        _t++; Thread.sleep((long) sleep); TWeb.Element_Child_List_L1("Menu list Count", e1,"xpath", ".//div[@class='v-list__tile__title']", "no_jira");                                     
            ...
            if(L1.size() > 0 && !"No data available".equals(t)){
                ...
                _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Click("Click > 'Start Time Field'", "css", "[aria-label='Start Time']", "no_jira");
                    if (FAIL) { return;}
                _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Text_Enter("Enter a Start Time", "css", "[aria-label='Start Time']", String.valueOf(hour + 1) + "000A", false,"no_jira");
a                    if (FAIL) { return;}
                _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Click("Click > 'End Time Field'", "css", "[aria-label='End Time']", "no_jira");
                    if (FAIL) { return;}
                _t++; Thread.sleep((long) sleep); TWeb.Element_By_Path_Text_Enter("Enter a End Time", "css", "[aria-label='End Time']", String.valueOf(hour + 1) + "000P", false,"no_jira");
                    if (FAIL) { return;}
