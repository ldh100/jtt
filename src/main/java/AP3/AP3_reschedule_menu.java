...
public class AP3_reschedule_menu {
    ...
    public static void run() throws InterruptedException {
        ...
        String endTime = endTimes[new Random().nextInt(endTimes.length)];
            ...
            if (L2.size() == L0.size()) {
                _t++;
                _p++; EX += _t + "\t" + "Expected number of Scheduled Menus" + "\t" + "-" + "\t" + L0.size() + "\t" + "PASS" + "\t" + " - " + "\t" + " - " + "\t" + LocalDateTime.now().format(Time_12_formatter) + "\t" + "no_jira" + "\r\n";
            } else {
                _t++;
                _f++; EX += _t + "\t" + "Expected number of Scheduled Menus" + "\t" + "-" + "\t" + L0.size() + "\t" + "FAIL" + "\t" + "reschduled menu may have cause an unexpected duplication" + "\t" + " - " + "\t" + LocalDateTime.now().format(Time_12_formatter) + "\t" + "no_jira" + "\r\n";
            }           
                    //------- AUT-850
    }
}
