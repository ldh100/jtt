...
class posid_ranges extends C360_GUI{
    ...
    try { 
        ...
        Find_Text("Find Navigation node 'Concepts'", "POSID Ranges", true, ParentTest, "no_jira");    
        Element_By_Path_Click("Click > 'User'", "xpath", "//a[@label='POSID Ranges']/ancestor::span[@class='p-treenode-label']", ParentTest, "no_jira"); 
             if (FAIL) { return;}           
