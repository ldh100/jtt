...
class concepts_groups extends C360_GUI{
    ...
    try { 
        ...
        Element_By_Path_Click("Click > 'User'", "xpath", "//a[@label='Concept Groups']/ancestor::span[@class='p-treenode-label']", ParentTest, "no_jira"); 
             if (FAIL) { return;}           
        ...
        Element_By_Path_Text("Find 'New Concept Group' button text", "xpath", "//button[@class='p-button p-component w-full']", ParentTest, "no_jira");
        Element_By_Path_Click("Click 'New Concept Group' button", "xpath", "//button[@class='p-button p-component w-full']", ParentTest, "no_jira");
             if (FAIL) { return;}
        Thread.sleep(500);        
