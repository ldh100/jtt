...
class C360_login extends C360_GUI{
    ...
    protected void Run() throws InterruptedException, Exception{  
        ...
        Wait_For_Element_By_Path_Presence("Wait for Home Image", "xpath", "//div[contains(@style, 'cafe-360-home-image')]", ParentTest,"no_jira");
            if (FAIL) { return;}
        Page_URL("C360 Login page", ParentTest, "no_jira"); 
        Element_By_Path_Text("Get 'Welcome' text", "xpath", "//h1[contains(@class, 'welcomeText')]", ParentTest,"no_jira");
